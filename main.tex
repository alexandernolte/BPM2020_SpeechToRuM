...
\begin{sloppypar}
%
\title{Ensuring Model Consistency in \\ Declarative Process Discovery%
\thanks{The research of Claudio {Di Ciccio} and Jan Mendling has received funding from the EU Seventh Framework Programme under grant agreement 318275 (GET Service). The research of Fabrizio Maria Maggi has received funding from the Estonian Research Council and by ERDF via the Estonian Centre of Excellence in Computer Science.}%
}
%
...
%
\author{{Claudio~{Di~Ciccio}}\inst{1} %
\and {{Fabrizio~Maria}~Maggi}\inst{2} %
\and {Marco~Montali}\inst{3} %
\and {Jan~Mendling}\inst{1}%
}
%
% abbreviated author list (for running head)
\authorrunning{C.\ {Di Ciccio}, F.M.\ Maggi, M.\ Montali, J.\ Mendling}
%
\institute{Vienna University of Economics and Business, Austria\\
\email{\{claudio.di.ciccio,jan.mendling\}@wu.ac.at}
\and
