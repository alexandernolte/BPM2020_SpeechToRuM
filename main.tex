...
%		\bibliography{Bibliography}
			...
			\begin{thebibliography}{10}
				...
				\bibitem{epure2015automatic}
				Epure, E.V., Mart{\'\i}n-Rodilla, P., Hug, C., Deneck{\`e}re, R., Salinesi, C.:
				Automatic process model discovery from textual methodologies. In:RCIS. pp. 19--30. IEEE (2015)
				...
				\bibitem{gonccalves2009business}
				de~Gon{\c{c}}alves, J.C., Santoro, F.M., Baiao, F.A.: Business process mining
				from group stories. In: CSCWD. pp. 161--166. IEEE (2009)
				...
				\bibitem{riefer2016mining}
				Riefer, M., Ternis, S.F., Thaler, T.: Mining process models from natural
				language text: A state-of-the-art analysis. MKWI. pp. 9--11 (2016)
			
				
				\bibitem{sanchez2018aligning}
				S{\`a}nchez-Ferreres, Josep and Van der Aa, Han and Carmona, Josep and Padr{\'o}, Llu{\'\i}s: Aligning textual and model-based process descriptions. Data Knowl. Eng. 118,  25--40 (2018)
