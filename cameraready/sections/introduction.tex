...
The remainder of the paper is structured as follows. \autoref{sec:background} introduces \MPDeclare\ and the transformation of natural language into \Declare. \autoref{sec:framework} presents our conceptual contributions on the generation of multi-perspective constraints based on natural language input, while Sect.~\ref{sec:implementation} presents the implemented toolkit. \autoref{sec:evaluation} discusses the evaluation conducted to assess the usability of our tool. Finally, Sect.~\ref{sec:relatedwork} considers related work, before concluding in Sect.~\ref{sec:conclusion}.
