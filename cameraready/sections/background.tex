...
For example, we can say that whenever \emph{ship order} occurs with order amount higher than $100\euro$, and customer type \emph{gold}, eventually an invoice must be sent with the same order amount.
%
