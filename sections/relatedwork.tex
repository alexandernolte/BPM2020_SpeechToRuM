...
To allow these documents to be used for automated process analysis, such as conformance checking, a variety of techniques have been developed to extract process models from texts, cf.,~\cite{schumacher2013extracting,de2017assisting,friedrich2011process}.
...
In the context of declarative process models, some recent works also provide support for the extraction of DCR graphs from textual descriptions~\cite{lopez2019assisted,lopez2018process}, whereas preliminary work on the extraction of \Declare\ constraints from texts~\cite{vanderaa2019extracting} represents a foundation for our work.
