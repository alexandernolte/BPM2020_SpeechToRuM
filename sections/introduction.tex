...
The remainder of the paper is structured as follows. \autoref{sec:background} introduces background on \MPDeclare\ and the transformation of natural language into declarative constraints. \autoref{sec:framework} presents our conceptual contributions with respect to the generation of declarative constraints and multi-perspective conditions based on natural language input, while \autoref{sec:implementation} presents the implemented toolkit. \autoref{sec:evaluation} discusses the evaluation conducted to assess the usability of our tool. Finally, \autoref{sec:relatedwork} considers related work, before concluding in \autoref{sec:conclusion}.
