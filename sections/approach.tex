...
\mypar{Time conditions} A time conditions bounds the time between the occurrence of the activation and a target of a declarative constraint, e.g., stating that a response should occur within 5 days of the activation. 
